...
export const OracleSourceCustomList: {
  ...
  MAKER_RWA002: {
    ...
    chain: 'ethereum',
    address: '0x35d1b3f3d7966a1dfe207aa4514c12a259a0492b',
    token: EthereumTokenList['0xaaa760c2027817169d7c8db0dc61a2fb4c19ac23'],
  ...
  MAKER_RWA003: {
    ...
    chain: 'ethereum',
    address: '0x35d1b3f3d7966a1dfe207aa4514c12a259a0492b',
    token: EthereumTokenList['0x07f0a80ad7aeb7bfb7f139ea71b3c8f7e17156b9'],
  ...
  MAKER_RWA004: {
    ...
    chain: 'ethereum',
    address: '0x35d1b3f3d7966a1dfe207aa4514c12a259a0492b',
    token: EthereumTokenList['0x873f2101047a62f84456e3b2b13df2287925d3f9'],
  ...
  MAKER_RWA005: {
    ...
    chain: 'ethereum',
    address: '0x35d1b3f3d7966a1dfe207aa4514c12a259a0492b',
    token: EthereumTokenList['0x6db236515e90fc831d146f5829407746eddc5296'],
  ...
  MAKER_RWA006: {
    ...
    chain: 'ethereum',
    address: '0x35d1b3f3d7966a1dfe207aa4514c12a259a0492b',
    token: EthereumTokenList['0x4ee03cfbf6e784c462839f5954d60f7c2b60b113'],
  ...
  MAKER_RWA007: {
    ...
    chain: 'ethereum',
    address: '0x35d1b3f3d7966a1dfe207aa4514c12a259a0492b',
    token: EthereumTokenList['0x078fb926b041a816facced3614cf1e4bc3c723bd'],
  ...
  MAKER_RWA008: {
    ...
    chain: 'ethereum',
    address: '0x35d1b3f3d7966a1dfe207aa4514c12a259a0492b',
    token: EthereumTokenList['0xb9737098b50d7c536b6416daeb32879444f59fca'],
  ...
  MAKER_RWA009: {
    ...
    chain: 'ethereum',
    address: '0x35d1b3f3d7966a1dfe207aa4514c12a259a0492b',
    token: EthereumTokenList['0x8b9734bbaa628bfc0c9f323ba08ed184e5b88da2'],
  ...
  MAKER_RWA012: {
    ...
    chain: 'ethereum',
    address: '0x35d1b3f3d7966a1dfe207aa4514c12a259a0492b',
    token: EthereumTokenList['0x3c7f1379b5ac286eb3636668deae71eaa5f7518c'],
  ...
  MAKER_RWA014: {
    ...
    chain: 'ethereum',
    address: '0x35d1b3f3d7966a1dfe207aa4514c12a259a0492b',
    token: EthereumTokenList['0x75dca04c4acc1ffb0aef940e5b49e2c17416008a'],
  ...
  MAKER_RWA013: {
    ...
    chain: 'ethereum',
    address: '0x35d1b3f3d7966a1dfe207aa4514c12a259a0492b',
    token: EthereumTokenList['0xd6c7fd4392d328e4a8f8bc50f4128b64f4db2d4c'],
  ...
  MAKER_RWA015: {
    ...
    chain: 'ethereum',
    address: '0x35d1b3f3d7966a1dfe207aa4514c12a259a0492b',
    token: EthereumTokenList['0xf5e5e706efc841bed1d24460cd04028075cdbfde'],
