...
export interface AaveIncentiveEventInterfaces extends AaveEventInterfaces {
...
export const Aavev2EventSignatures: AaveIncentiveEventInterfaces = {
  ...
  RewardsAccrued: '0x3303facd24627943a92e9dc87cfbb34b15c49b726eec3ad3487c16be9ab8efe8',
};

export const Aavev3EventSignatures: AaveIncentiveEventInterfaces = {
...
export const Aavev3EventAbiMappings: { [key: string]: Array<any> } = {
  ...
  [Aavev3EventSignatures.RewardsAccrued]: [
    {
      indexed: true,
      internalType: 'address',
      name: 'asset',
