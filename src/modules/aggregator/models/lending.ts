...
//         dataState.volumeCollateralDeposited.valueUsd += collateral.volumeDeposited.valueUsd;
//         dataState.volumeCollateralWithdrawn.valueUsd += collateral.volumeWithdrawn.valueUsd;
//       }
//
//       dataState.markets.push(market);
//     }
...
//       },
//     });
//     const transformedSnapshots: Array<any> = [];
//     for (const snapshot of snapshots) {
//       const transformedSnapshot: any = {
//         timestamp: snapshot.timestamp,
//         totalDebts: new BigNumber(snapshot.totalDebts).multipliedBy(new BigNumber(snapshot.tokenPrice)).toNumber(),
//         volumeBorrowed: new BigNumber(snapshot.volumeBorrowed)
//           .multipliedBy(new BigNumber(snapshot.tokenPrice))
//           .toNumber(),
//         volumeRepaid: new BigNumber(snapshot.volumeRepaid).multipliedBy(new BigNumber(snapshot.tokenPrice)).toNumber(),
//         volumeFeesPaid: new BigNumber(snapshot.volumeFeesPaid)
//           .multipliedBy(new BigNumber(snapshot.tokenPrice))
//           .toNumber(),
//
...
//         transformedSnapshot.totalCollateralDeposited += new BigNumber(collateral.totalDeposited)
//           .multipliedBy(new BigNumber(collateral.tokenPrice))
//           .toNumber();
//         transformedSnapshot.volumeCollateralDeposited += new BigNumber(collateral.volumeDeposited)
//           .multipliedBy(new BigNumber(collateral.tokenPrice))
//           .toNumber();
//         transformedSnapshot.volumeCollateralWithdrawn += new BigNumber(collateral.volumeWithdrawn)
//           .multipliedBy(new BigNumber(collateral.tokenPrice))
//           .toNumber();
//       }
//
//       transformedSnapshots.push(transformedSnapshot);
//     }
//
//     const fields: Array<string> = [
//       'totalDebts',
...
//     ];
//
//     const groupedSnapshots = HelperTransform.groupSnapshotList(transformedSnapshots, fields);
//     const dayData: Array<AggCdpLendingDayData> = [];
//     for (const item of groupedSnapshots) {
//       const data: any = {
...
//     }
//
//     dataState.dayData = dayData.sort(function (a, b) {
//       return a.timestamp > b.timestamp ? 1 : -1;
//     });
//
//     return dataState;
